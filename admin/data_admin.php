                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="home.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31"></a>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="tambah_admin.php" class="btn btn-primary float-right mb-3">Tambah</a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $data['telp'] ?></td>
                                                    <!-- <td>
                                                        <a href="edit_rekap.php?admin_id=<?= $data['admin_id'] ?>" class="btn btn-warning">Edit</a>
                                                    </td> -->
                                                </tr>
                                            <?php
                                            }

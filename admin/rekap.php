                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="tambah_rekap.php" class="btn btn-primary float-right mb-3">Tambah</a>
                                <button type="button" class="btn btn-info mr-2 margin-5 text-white float-right" data-toggle="modal" data-target="#Modal2">
                                    Import
                                </button>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group row">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="file" class="form-control" name="filerekap" id="fname" placeholder="Logo">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $query = mysqli_query($con, "select * from rekap where admin_id='$admin_id'");
                                            $i = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $data['status'] ?></td>
                                                    <td>
                                                        <a href="edit_rekap.php?rekap_id=<?= $data['rekap_id'] ?>" class="btn btn-warning">Edit</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }

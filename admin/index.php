...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center " style="background-color: #37517E;">
            <div class="auth-box border-top border-secondary" style="background-color: #37517E;">
                <div id="loginform">
                    <div class="text-center p-b-10">
                        <span class="db"><img src="../assets/images/smk.png" width="30%" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-10" id="loginform" action="proses_login_admin.php" method="post">

            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item "> <a class="sidebar-link waves-effect waves-dark sidebar-link " href="rekap.php" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Rekap</span></a></li>
                        <li class="sidebar-item selected"> <a class="sidebar-link waves-effect waves-dark sidebar-link active" href="data_admin.php" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Data Admin</span></a></li>
                    </ul>
                </nav>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form class="form-horizontal" action="proses_tambah_admin.php" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3  control-label col-form-label">Lembaga</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="lembaga" id="fname" placeholder="Lembaga">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3  control-label col-form-label">Logo</label>
                                        <div class="col-sm-9">
                                            <input type="file" class="form-control" name="logo" id="fname" placeholder="Logo">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3  control-label col-form-label">Telp</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="telp" id="fname" placeholder="Telp">
                                        </div>
                                    </div>
                                </div>

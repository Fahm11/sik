...
$query = mysqli_query($con, "select * from rekap where rekap_id='$id'");
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form class="form-horizontal" action="proses_edit_rekap.php" method="post">
                                <div class="card-body">
                                    <h4 class="card-title">Edit Rekap</h4>
